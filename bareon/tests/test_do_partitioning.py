...
from bareon.drivers.deploy import nailgun
...
class TestPartitioningAction(unittest2.TestCase):
    ...
    @mock.patch('bareon.drivers.deploy.nailgun.Nailgun.parse_image_meta',
                return_value={})
    @mock.patch('bareon.drivers.deploy.nailgun.hu.list_block_devices')
