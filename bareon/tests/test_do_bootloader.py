...
class TestBootLoaderAction(unittest2.TestCase):
    ...
    @mock.patch.object(bootloader, 'fu', autospec=True)
    @mock.patch.object(bootloader, 'helpers', autospec=True)
    ...
    def test_do_bootloader_writes(self, mock_helpers, mock_fu, mock_utils,
        ...
        mock_helpers.mount_target.assert_called_once_with(self.drv,
                                                          '/tmp/target')
        ...
        mock_helpers.umount_target.assert_called_once_with(self.drv,
                                                           '/tmp/target')
