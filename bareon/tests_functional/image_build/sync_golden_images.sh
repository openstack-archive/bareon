...
GOLDEN_IMAGE_SOURCE=http://images.fuel-infra.org/rft_golden_images/
...
wget -r -P $GOLDEN_IMAGE_DIR -nc -nH --cut-dirs=2 --no-parent --reject "index.html*" $GOLDEN_IMAGE_SOURCE
